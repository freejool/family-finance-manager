...
public class FamilyBonusAdapter extends ArrayAdapter<UserProfit> {

    private final int resource;

    public FamilyBonusAdapter(@NonNull Context context, int resource, @NonNull List<UserProfit> objects) {
